...
class CreateTablePreFormularioChamados extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('preformulariochamados', function(Blueprint $table){
    ...
    {
        Schema::dropIfExists('preformulariochamados');
    }
}
